...
const { addCategory, getCategories,deleteCategory ,updateCategory} = require('../controller/category')
...
router.post('/categories/delete',requireSignin,adminMiddleware ,deleteCategory)
